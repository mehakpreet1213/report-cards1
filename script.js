...
const std_science_mark = document.querySelector(".i-science-sec");
const std_punjabi_mark = document.querySelector(".i-punjabi-sec");
const std_english_mark = document.querySelector(".i-english-sec");
const std_math_mark = document.querySelector(".i-math-sec");
const std_sst_mark = document.querySelector(".i-sst-sec");
const std_result = document.querySelector(".i-res");
const std_mob = document.querySelector(".i-mob");
const std_science_total = document.querySelector(".i-science-total");
const std_punjabi_total = document.querySelector(".i-punjabi-total");
const std_math_total = document.querySelector(".i-math-total");
const std_english_total = document.querySelector(".i-english-total");
const std_sst_total = document.querySelector(".i-sst-total");
...
function send_data_for_print() {
    total_mark_secured = parseFloat(std_sst_mark.value) + parseFloat(std_math_mark.value) + parseFloat(std_science_mark.value) + parseFloat(std_punjabi_mark.value) + parseFloat(std_english_mark.value) ;
    full_subject_mark = parseFloat(std_science_total.value)+ parseFloat(std_math_total.value) + parseFloat(std_punjabi_total.value) + parseFloat(std_sst_total.value) + parseFloat(std_english_total.value);
...
function send_data_from_form() {
    ...
    document.querySelector("#p-science-total").innerHTML = std_science_total.value;
    document.querySelector("#p-science-mark").innerHTML = std_science_mark.value;
    document.querySelector("#p-punjabi-total").innerHTML = std_punjabi_total.value;
	document.querySelector("#p-punjabi-mark").innerHTML = std_punjabi_mark.value;
    document.querySelector("#p-math-total").innerHTML = std_math_total.value;
    document.querySelector("#p-math-mark").innerHTML = std_math_mark.value;
    document.querySelector("#p-english-total").innerHTML = std_english_total.value;
	document.querySelector("#p-english-mark").innerHTML = std_english_mark.value;
    document.querySelector("#p-sst-total").innerHTML = std_sst_total.value;
    document.querySelector("#p-sst-mark").innerHTML = std_sst_mark.value;
...
function GenerateCard_bw(){
    ...
    html2canvas($(".table_bw-div"), { // DIV ID HERE
        onrendered: function(canvas) {
            ...
            var doc = new jsPDF('portrait');
            doc.addImage(imgData, 'PDF', 10, 10);
            doc.save('report-card.pdf'); //SAVE PDF FILE
        }
    });
...
function reset_table(argument) {
    ...
    std_gender.value = "";
    std_math_mark.value = "";
    std_punjabi_mark.value = "";
    std_sst_mark.value = "";
    std_section.value = "";
    std_science_mark.value="";
    std_father_name.value = "";
    std_result.value = "";
    std_english_mark.value="";
}
